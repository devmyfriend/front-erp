...
const editarProducto = (codigoProducto) => {
    ...
    router.push({ name: 'formularioProductos', params: { tipo: tipoProducto, id: codigoProducto } });
}
...
<template>
    <LayoutGeneral>
        ...
        <template v-slot:Ventanas>
                <ventanasProductos :tipoProducto="tipoProducto" :btActivo="btActivo" :codigoProducto="CodigoProducto" />
        </template>
            ...
            <div class="w-full h-full max-h-full min-h-full bg-container">
                ...
                <div class="frm flex justify-between mb-6">
                    ...
                    <div class="formulario w-full flex flex-row items-center gap-frmGap justify-end">
                        ...
                        <btnAgregar :ruta="'formularioProductos'"/>
                    </div>
                </div>
