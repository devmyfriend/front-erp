<template>
    <div class="flex items-center h-inputHeight w-full md:w-auto" @focusout="txtBusqueda=''">
        <input
            name="buscador"
            class="outline-none h-full text-base border-gray-500 text-black rounded-inputRadius border-inputWidth p-paddingInput lg:w-96 md:w-60 w-32 hover:border-inputBorder focus:border-inputBorder flex-grow"
