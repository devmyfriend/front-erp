        ...
        <div class="m-4 gap-y-4 flex flex-col">
            ...
            <div class="mt-4 gap-y-4 flex flex-col">
                <div class="min-w-full flex-wrap flex">
                    <label class="max-w-48 min-w-48 text-[1rem] items-center flex" for="tipoProducto"> Tipo de producto:
                    </label>
                ...
                <div class="min-w-full flex-wrap flex">
                    <label class="max-w-48 min-w-48 text-[1rem] items-center flex" for="CodigoProducto"> Código del
                        producto: </label>
                    <input type="text" v-model="registro.CodigoProducto" id="CodigoProducto">
                </div>
                <div class="min-w-full flex-wrap flex">
                    <label class="max-w-48 min-w-48 text-[1rem] items-center flex" for="NombreProducto"> Nombre del
                        producto: </label>
                    <input type="text" v-model="registro.NombreProducto" id="NombreProducto">
                </div>
                <div class="flex flex-wrap descr">
                    <label class="max-w-48 min-w-48 text-[1rem]" for="DescripcionProducto"> Descripción del producto:
                    </label>
                ...
                <div class="min-w-full flex-wrap max-w-full flex gap-4">
                    ...
                    <div class="flex">
                        <label class="max-w-48 min-w-48 md:max-w-none md:min-w-1 text-[1rem] items-center flex md:mr-4"
            ...
            <div class="gap-y-4 flex flex-col">
                ...
                <div class="min-w-full flex-wrap flex">
                    <label class="max-w-48 min-w-48 text-[1rem] items-center flex" for="familiaProducto"> Familia:
                    </label>
                ...
                <div class="min-w-full flex-wrap flex">
                    <label class="max-w-48 min-w-48 text-[1rem] items-center flex" for="subfamiliaProducto"> Subfamilia:
                    </label>
                ...
                <div class="min-w-full flex-wrap flex">
                    <label class="max-w-48 min-w-48 text-[1rem] items-center flex" for="ClaveProductoServicio"> C.
                        Producto SAT: </label>
                ...
                <div class="min-w-full flex-wrap flex">
                    <label class="max-w-48 min-w-48 text-[1rem] items-center flex" for="ClaveUnidadSAT"> C. Unidad SAT:
                    </label>
                ...
                <div class="min-w-full flex-wrap flex">
                    <label class="max-w-48 min-w-48 text-[1rem] items-center flex" for="ImpuestoCompuesto"> C. Impuesto
                        Compuesto: </label>
