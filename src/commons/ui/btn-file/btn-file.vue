...
<template>
    <div class="m-4 mt-0">
        ...
        class="hidden"
        ref="fileInput"
        @change="imprimirImagen"
        />
        <button
        @click="cargarImagen"
        class="col-span-2 bg-primaryBtnColor 
        text-secondaryFontColor flex gap-4
        p-primaryPaddingButton border-none
        rounded-primaryButtonRadius justify-center 
        items-center uppercase text-base font-bold 
        h-10 w-56 hover:bg-sidebar transition-all duration-300">
            <svg width="16" height="16" viewBox="0 0 32 32" fill="none" xmlns="http://www.w3.org/2000/svg"  class="imgButton">
