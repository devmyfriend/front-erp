...
<template>
    <button 
    type="submit"
    class="col-span-2 bg-primaryBtnColor 
    text-secondaryFontColor grow flex 
    p-primaryPaddingButton border-none gap-4
    rounded-primaryButtonRadius justify-center items-center 
    uppercase text-base font-bold h-10 hover:bg-sidebar transition-all duration-300">
        <svg width="24" height="24" viewBox="0 0 32 32" fill="none" xmlns="http://www.w3.org/2000/svg"  class="imgButton">
        ...
        {{ props.modo === 0 ? 'Guardar' : 'Actualizar'}} {{ props.elemento }}
    </button>
</template>
