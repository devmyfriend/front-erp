...
<template>
    ...
    :class="`bg-${theme}-primary hover:bg-${theme}-secondary`">
        <svg v-if="modo === 0" class="btn-icon" width="20" height="20" id="Capa_1" data-name="Capa 1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 500 500">
        ...
        <svg v-else class="btn-icon" width="24" height="20" id="Capa_1" data-name="Capa 1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 363.34 500">
