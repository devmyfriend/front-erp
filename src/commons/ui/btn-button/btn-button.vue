...
<template>
    <button @click="click()" class="btn-general" :class="`bg-${theme}-primary hover:bg-${theme}-secondary`">
        <svg v-if="iconSave === true" width="24" height="24" viewBox="0 0 32 32" fill="none" class="btn-icon"
